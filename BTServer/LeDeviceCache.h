...
-(LeDevice*)loadPairedDevice:(UUID)arg1 address:(LeDeviceAddress)arg2 ;
-(LeDevice*)readDevice:(UUID)arg1 ;
-(LeDevice*)readDeviceByAddress:(LeDeviceAddress)arg1 ;
-(int)duplicatePairedDevicesForAddress:(LeDeviceAddress)arg1 originalUuid:(UUID)arg2 ;
