...
+(id)sharedInstance;
-(id)platters_favoriteIndexPath;
-(void)platters_setFavoriteIndexPath:(id)arg1 ;
-(BOOL)platters_selectingNewFavorite;
-(void)platters_setSelectingNewFavorite:(BOOL)arg1 ;
-(void)_revealMenuForIconView:(id)arg1 presentImmediately:(BOOL)arg2 ;
-(void)activator_iconDoubleTapTimedOut;
