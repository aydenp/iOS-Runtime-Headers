...
-(CGRect)frame;
-(void)activatorFlickDownGestureRecognized:(id)arg1 ;
-(void)activatorFlickUpGestureRecognized:(id)arg1 ;
-(void)activatorFlickRightGestureRecognized:(id)arg1 ;
-(void)activatorFlickLeftGestureRecognized:(id)arg1 ;
