...
@interface Music.JSCapabilitiesController : Music.JSObject {

	 allowsConnectContentNotificationObserver;
	 allowsRadioContentNotificationObserver;
	 allowsSubscriptionContentNotificationObserver;
	 hasUserRequestedSubscriptionHiddenObserver;
	 isCloudLibraryEnabledDidChangeNotificationObserver;
