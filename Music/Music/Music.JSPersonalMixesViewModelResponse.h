...
@interface Music.JSPersonalMixesViewModelResponse : MPModelResponseSwiftShim <MPModelResponseDetailedKeepLocalStatusRequesting> {

	 itemsDidChangeNotificationObserver;
